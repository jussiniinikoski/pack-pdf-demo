window.addEventListener('DOMContentLoaded', () => {
    ...
    let productARow = generateEmptyRow(weeksInYear);
    ...
    let vacationRow = generateEmptyRow(weeksInYear);
    ...
    let tvCampaignRow = generateEmptyRow(weeksInYear);
